# Generated by Powerlevel10k configuration wizard on 2022-02-11 at 22:52 +04.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%025F╭'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%025F├'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%025F╰'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=216
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*test*'  LAB    # to match your needs. Customize them as needed.
      '*lab*'   LAB    # to match your needs. Customize them as needed.
      '*poc*'   LAB    # to match your needs. Customize them as needed.
      '*dev*'   DEV    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_FOREGROUND=134
  typeset -g POWERLEVEL9K_KUBECONTEXT_LAB_FOREGROUND=76
